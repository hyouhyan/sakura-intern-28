...
CREATE INDEX idx_posts_parent_created ON posts (parent_post_id, created_at, id);

-- ユーザーの投稿一覧、ユーザーごとの投稿数集計向け
CREATE INDEX idx_posts_user_parent_created ON posts (user_id, parent_post_id, created_at, id);
